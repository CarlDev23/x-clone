...
<body>
    ...
    <div class="main-flex-container">
        <div class="left-flex-container flex-item">
            <div class="nav-links">
                <ul>
                    <li class="nav-items logo"><img src="x-logo.png" alt="" width="50px" height="50px"></li>
                    <li class="nav-items current-page"><a href="#"><i class="fa-solid fa-house"></i> Home</a></li>
            ...
            <div class="profile-box">
                ...
                <div class="profile-link">
                    <p class="full-name"> <?php echo $_SESSION['name']; ?></p>
                    <p class="user-name"><?php echo $_SESSION['user_name']; ?></p>
                </div>
                <div class="options-icon"><i class="fas fa-caret-down">
                    </i></div>
            </div>
        </div>
        ...
        <div class="center-flex-container flex-item">
            ...
            <div class="tweets">
                ...
                <div class="user-content-box">
                    ...
                    <div class="user-content">
                        <p>We've gotta send kids back to school so one day they can be doctors and scientists, and
                            everyone can ignore them.</p>
                    </div>
                ...
                <div class="user-content-box">
                    ...
                    <div class="user-content">
                        <p>If the whole world was blind, how many people would you impress?
                            <a href="#">#100daysofcode</a> <a href="#">#javascript</a> <a href="#">#womenwhocode</a>
                        </p>
                    </div>
            ...
            <div class="tweets">
                ...
                <div class="user-content-box">
                    ...
                    <div class="user-content">
                        <p>There's no clear correlation between your background and what you are going to achieve in
                            life..</p>
                    </div>
                    ...
                    <div class="user-profile">
                        ...
                        <div class="user-profile-content">
                            ...
                            <div class="bio-container">
                                <p><a href="#">♯WordPress/Php</a> Geek Smiling face with sunglasses <a
                                        href="#">♯JavascriptDeveloper</a> Slightly smiling face <a
                                        href="#">♯ToolsCreator</a> <a href="#">♯http://webscreenshot.now.sh</a> Always
                                    ready to help with code Handshake</p>
                            </div>
                ...
                <div class="follow-user">
                    ...
                    <div class="user-profile">
                        ...
                        <div class="user-profile-content">
                            ...
                            <div class="bio-container">
                                <a href="#">♯JavascriptDeveloper</a> Avocado | Fire Speaker | Fire Teacher | Youtube -
                                <a href="#">http://bit.ly/jqqyt</a> |<a href="#"> @twilio</a> Champion | Motto: <a
                                    href="#">#LearnBuildTeach</a></p>
                            </div>
                        ...
                        <div class="user-profile-content">
                            ...
                            <div class="bio-container">
                                <p>software engineer at
                                    ...
                                    . career switcher. vue + rails. tweeting about tech, books, startups, and big ideas.
                                    writing @ <a href="#">http://jamestucker.dev.</a>
                                </p>
                            </div>
